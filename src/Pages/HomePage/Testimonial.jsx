...
const Testimonial = () => {
    ...
    return (
        <div>
            ...
            <div class="min-w-screen min-h-[50vh] bg-gray-50 flex items-center justify-center py-5">
                <div class="w-full bg-white border-gray-200 px-5 text-gray-800">
                    <div class="w-full max-w-6xl mx-auto">
                        <div class="text-center max-w-xl mx-auto">
                            <h1 class="text-3xl font-bold mb-5 ">What people are saying.</h1>
                            <h3 class="text-xl mb-5 font-light">Feedback from client about us</h3>
                        </div>
                        <Carousel swipeable={false}
                            ...
                            <div class="w-full rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light m-5">
