...
const AddToy = () => {
    ...
    const handleToyData = e => {
        ...
        fetch('https://animals-toyhub-server-production.up.railway.app/alltoys', {
            method: "POST",
            headers: {
        ...
        <HelmetProvider>
            <div>
                ...
                <form className='p-5' onSubmit={handleToyData}>
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        <input autoComplete='off' type="text" name="photoUrl" id="photoUrl" className="text-black block py-2.5 px-0 w-full text-xl  bg-transparent border-0 border-b-2 font-semibold appearance-none border-black dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div className="grid md:grid-cols-2 md:gap-6">
                        <div className="relative z-0 w-full mb-6 group">
                            <input autoComplete='off' type="text" name="price" id="price" className="text-black block py-2.5 px-0 w-full text-xl  bg-transparent border-0 border-b-2 font-semibold appearance-none border-black dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div className="grid md:grid-cols-2 md:gap-6">
                        <div className="relative z-0 w-full mb-6 group">
                            <input autoComplete='off' type="text" name="ratings" id="ratings" className="text-black block py-2.5 px-0 w-full text-xl  bg-transparent border-0 border-b-2 font-semibold appearance-none border-black dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Toy</button>
                </form>
